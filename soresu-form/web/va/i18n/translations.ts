export const translationsFi = {
  ...
  contactPersonEdit: {
    ...
    resetYhteishankeOrganizations: 'Peru osapuoliin tehdyt muutokset',
...
const translationsSv: Translations = {
  ...
  contactPersonEdit: {
    ...
    updateYhteishankeContacts: 'Jag uppdaterar kontaktuppgifterna för parterna i ett samprojekt',
    updateYhteishankeOrganizations: 'Jag lägger till eller tar bort parter i ett samprojekt',
    addYhteishankeOrganization: 'Lägg till en part i samprojektet',
    removeYhteishankeOrganization: 'Ta bort',
    resetYhteishankeOrganizations: 'Ångra ändringarna',
