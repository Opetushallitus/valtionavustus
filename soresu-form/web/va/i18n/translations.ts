export const translationsFi = {
  ...
  sisaltomuutos: {
    ...
    title:
      "Kuvaile ja perustele hankkeen sisältöön tai toteutustapaan haettavat muutokset",
    appliedChange: "Haettu muutos hankkeen sisältöön tai toteutustapaan",
    acceptedChanges:
      "Hyväksytyt muutokset hankkeen sisältöön tai toteutustapaan",
  },
  ...
  muutoshakemus: {
    ...
    paatos: {
      ...
      muutoshakemusTaloudenKayttosuunnitelmaan:
        "Muutoshakemus talouden käyttösuunnitelmaan.",
      hakemusKayttoajanPidennykselle:
        "Hakemus avustuksen käyttöajan pidennykselle.",
...
const translationsSv: Translations = {
  ...
  muutoshakemus: {
    ...
    paatos: {
      ...
      asia: "Ärende",
      processed: "Behandlad",
      linkkiMuutoshakemukseen:
        "Visa alla ändringar som ni ansökt om inklusive motiveringar",
      ...
      hakemusKayttoajanPidennykselle:
        "Ändringsansökan som gäller understödets användningstid",
      ...
      status: {
        accepted:
          "Utbildningsstyrelsen har godkänt ändringarna enligt ändringsansökan.",
        accepted_with_changes:
          "Utbildningsstyrelsen har godkänt ändringarna med vissa justeringar som beskrivs i detta beslut.",
        rejected:
          "Utbildningsstyrelsen har inte godkänt ändringarna enligt ändringsansökan.",
      },
      "paatos-talousarvio": {
        status: {
      ...
      "paatos-sisaltomuutos": {
        status: {
          accepted:
            "De ändringar som ni ansökt om i projektets innehåll och genomförande godkänns",
          rejected:
