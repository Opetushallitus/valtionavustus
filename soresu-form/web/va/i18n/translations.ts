export const translationsFi = {
  ...
  contactPersonEdit: {
    ...
    updateYhteishankeContacts: 'Päivitän yhteishankkeen osapuolten yhteystietoja',
    updateYhteishankeOrganizations: 'Lisään tai poistan yhteishankkeen osapuolia',
    addYhteishankeOrganization: 'Lisää yhteishankkeen osapuoli',
    removeYhteishankeOrganization: 'Poista osapuoli',
    resetYhteishankeOrganizations: 'Peru osapuolimuutokset',
  ...
  muutoshakemus: {
    ...
    paatos: {
      ...
      muutoshakemusYhteishankeenOsapuoliin: 'Muutoshakemus yhteishankkeen osapuoliin.',
...
const translationsSv: Translations = {
  ...
  contactPersonEdit: {
    ...
    updateYhteishankeContacts: '[SV] Päivitän yhteishankkeen osapuolten yhteystietoja',
    updateYhteishankeOrganizations: '[SV] Lisään tai poistan yhteishankkeen osapuolia',
    addYhteishankeOrganization: '[SV] Lisää yhteishankkeen osapuoli',
    removeYhteishankeOrganization: '[SV] Poista osapuoli',
    resetYhteishankeOrganizations: '[SV] Peru osapuolimuutokset',
    yhteishankeOrganizationName: '[SV] Yhteishankkeen osapuolen nimi',
    yhteishankeContactPerson: '[SV] Yhteyshenkilön nimi',
    yhteishankeEmail: '[SV] Yhteyshenkilön sähköposti',
  },
  applicationEdit: {
