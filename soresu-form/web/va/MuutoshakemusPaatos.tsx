    ...
    <Muutospaatos paatosStatus={status} osio="paatos-jatkoaika">
      ...
      <div className="muutoshakemus-paatos__jatkoaika">
        <div>
          ...
          <div className="muutoshakemus__date" data-test-id="paatos-project-end">{projectEndDate}</div>
        </div>
        <div>
          <h3 className="muutoshakemus-paatos__change-header" data-test-id="h-new-end-date">{t.muutoshakemus.acceptedChange}</h3>
          <div className="muutoshakemus__date" data-test-id="paattymispaiva-value">{moment(paattymispaiva).format(fiShortFormat)}</div>
        </div>
      </div>
    </Muutospaatos>
  )
