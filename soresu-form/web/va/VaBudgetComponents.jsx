              ...
              <tbody>
                <tr>
                  <td className="amount-label-column">
                    <LocalizedString
                      translations={translations}
                      translationKey="selfFinancingAmount"
                      lang={lang}
                    />
                  </td>
              ...
              <tbody>
                <tr>
                  <td className="percentage-label-column">
                    <LocalizedString
                      translations={translations}
                      translationKey="selfFinancingPercentage"
                      lang={lang}
                    />
                  </td>
                  <td className="percentage-value-column self-financing-percentage">
                    <span className={percentageClassNames}>
                      {isFinancingResultANumber
                        ? selfFinancingPercentageFormatted
                        : checkNumbersMessage}
                    </span>
                  </td>
                </tr>
                <tr>
                  ...
                  <td className="percentage-value-column oph-financing-percentage">
                    <span className={percentageClassNames}>
                      {isFinancingResultANumber
                        ? ophFinancingPercentageFormatted
                        : checkNumbersMessage}
                    </span>
                  </td>
                </tr>
