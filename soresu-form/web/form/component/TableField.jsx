...
export default class TableField extends React.Component {
  ...
  render() {
    ...
    const makeHelpTooltip = () => {
      ...
      return content ? <HelpTooltip content={content} lang={lang} /> : null
    }
    ...
    const makeValueCell = (cellValue, rowIndex, colIndex) => {
      ...
      return (
        <td
          className={makeValueCellClassNames(rowIndex, colIndex)}
        ...
        >
          <div className="soresu-table__cell-positioner">
            <input
              ...
              size={size}
              maxLength={maxLength}
              className={makeValueCellInputClassNames(
                cellsWithErrors[TableValidator.cellErrorIdFor(rowIndex, colIndex)]
              )}
              value={cellValue}
              disabled={disabled}
