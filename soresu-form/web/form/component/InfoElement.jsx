...
export class BasicInfoComponent extends React.Component {
  asDateTimeString(date) {
    const timeLimiter = new Translator(
      this.props.translations["misc"]
    ).translate("time", this.props.lang, "KLO");
    return (
...
export class ParagraphInfoElement extends BasicInfoComponent {
  render() {
    return (
      <p className="soresu-info-element">{this.translatedValue("text")}</p>
    );
  }
}
