          ...
          <div>
            ...
            <form onSubmit={this.handleOnSubmit}>
              <label className="modal-label">
                ...
                <input id="finnish-business-id" className={this.state.error} type="text" value={this.state.businessId} onChange={this.handleOnChange} autoFocus />
              </label>
            ...
            <p><a onClick={this.closeModal}><LocalizedString translations={this.translations} translationKey="cancel" lang={this.lang}/></a></p>
          </div>
        </ModalDialog>
      </div>)
  }
