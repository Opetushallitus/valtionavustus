...
export default class FormEditComponent extends React.Component {
  ...
  constructor(props) {
    ...
    this.componentFactory = new ComponentFactory({
      fieldTypeMapping: FormEditComponent.fieldTypeMapping(),
...
class TextFieldEditPropertyMapper {
  static map(props) {
    return EditPropertyMapperExtender.extendedMap(
      TextFieldPropertyMapper,
      props
    );
  }
...
class LinkEditPropertyMapper {
  static map(props) {
    const baseProps = EditPropertyMapperExtender.extendedMap(
      LinkPropertyMapper,
      props
    );
    return _.extend(baseProps, {
