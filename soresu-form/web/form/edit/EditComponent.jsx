...
export class EditComponent extends React.Component {
  ...
  static fieldClassWithValidation(value, validator, extraClassName) {
    const invalidClassName = validator
      ? validator(value)
        ? "error"
        : undefined
      : undefined;
  ...
  renderEditable(fieldSpecificEdit) {
    ...
    const editableFields = addableFields.filter(
    ...
    return (
      ...
      >
        ...
        <div className="soresu-field-content">
          ...
          {fieldSpecificEdit}
          <div
            className="soresu-field-add"
            data-test-id={`field-add-${field.id}`}
          >
    ...
    if (typeof field.required !== "undefined") {
      requiredEdit = (
        <span className="soresu-edit-property">
          <input
            onChange={this.fieldValueUpdater(
              (x) => x,
              "required",
              !field.required
            )}
...
export class InfoElementEditWrapper extends EditComponent {
  ...
  render() {
    ...
    return super.renderEditable(
      <div className="soresu-edit-wrapped-view">{textEdit}</div>
    );
  }
}
...
export class TextFieldEdit extends FieldEditComponent {
  ...
  render() {
    ...
    const maxLengthEdit = (
      <span
        className="soresu-edit-property"
        key={htmlId + "max-length-edit-property"}
      >
...
export class MultipleChoiceEdit extends FieldEditComponent {
  ...
  renderOption(field, option) {
    ...
    return (
      <div
        className="soresu-radio-option-edit"
