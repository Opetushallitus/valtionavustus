export default class UrlCreator {
  constructor(props) {
    ...
    this.existingSubmissionEditUrl =
      props.existingSubmissionEditUrl || defaultImpl;
    this.existingSubmissionPreviewUrl =
      props.existingSubmissionPreviewUrl || defaultImpl;
