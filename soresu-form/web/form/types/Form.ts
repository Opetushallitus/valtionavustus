...
export interface SelvitysAppStateTemplate
  extends InitialStateTemplate<SelvitysAppStateLoopState> {}

export interface VaAppStateTemplate
  extends InitialStateTemplate<VaAppStateLoopState> {
