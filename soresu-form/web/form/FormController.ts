...
export default class FormController<T extends BaseStateLoopState<T>, K> {
  ...
  constructor(props: FormControllerProps<T, K>) {
    this.initialStateTemplateTransformation =
      props.initialStateTemplateTransformation;
    ...
    this.getCustomFieldSyntaxValidator =
      this.getCustomFieldSyntaxValidator.bind(this);
  }
