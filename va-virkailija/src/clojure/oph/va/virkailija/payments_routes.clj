...
(defn- update-payment
  []
  (compojure-api/PUT "/:payment-id/"
                     [payment-id :as request]
                     :path-params
                     [payment-id :- Long]
                     :query-params
                     []
                     ...
                     :summary
                     "Create new payment for application"
...
(defn- get-next-installment-number
  ...
  (compojure-api/GET "/next-installment-number/"
                     ...
                     []
                     :return
                     virkailija-schema/PaymentInstallmentNumber
                     :summary
                     "Return next installment number"
...
(defn- create-payment
  ...
  (compojure-api/POST
    ...
    virkailija-schema/Payment
    :summary
    "Create new payment for application. Payment will be sent to Rondo
