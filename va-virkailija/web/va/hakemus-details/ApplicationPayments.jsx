...
export default class ApplicationPayments extends Component {
  ...
  static calculateDefaultValue(grant, application, payments) {
    if (
      ...
      return (
        application.arvio["budget-granted"] -
        ApplicationPayments.paidToDate(payments)
      );
    }
  }
  ...
  render() {
    ...
    const costsGranted =
      application["arvio"]["costsGranted"] || application["budget-total"];

    return (
      <div
        className={!this.props.payments ? "application-payments-disabled" : ""}
      >
        <h3>Maksuerät</h3>
