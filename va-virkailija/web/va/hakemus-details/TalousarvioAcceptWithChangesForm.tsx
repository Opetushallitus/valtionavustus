...
export const TalousarvioAcceptWithChangesForm = ({ f, talousarvio, requestedTalousarvio }: TalousarvioAcceptWithChangesFormProps) => {
  ...
  // @ts-ignore Formik provides incorrect error type
  const currentSumErrorElem = f.errors.talousarvio?.currentSum && <span className="muutoshakemus__error">{f.errors.talousarvio?.currentSum}</span>
  return (
    <React.Fragment>
      ...
      <div className="muutoshakemus_talousarvio_row">
        ...
        <div className="separator noborder" />
        <div className="requestedAmount" data-test-id="requested-sum">{f.values.talousarvio?.originalSum} €</div>
