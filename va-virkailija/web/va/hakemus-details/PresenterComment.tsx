...
export default class PresenterComment extends React.Component<
  PresenterCommentProps,
  PresenterCommentState
> {
  ...
  constructor(props: PresenterCommentProps) {
    ...
    this.changeBus.debounce(1000).onValue(([hakemus, value]) => {
      this.props.controller.setPresenterComment(hakemus, value);
    });
  }

  static getDerivedStateFromProps(
    props: PresenterCommentProps,
    state: PresenterCommentState
  ) {
