...
export default class ChooseRahoitusalueAndTalousarvioTili extends React.Component {
  ...
  render() {
    ...
    const availableRahoitusalueet =
      this.props.avustushaku.content.rahoitusalueet;
    ...
    return _.isEmpty(availableRahoitusalueet) ? null : (
      <div>
        <ChooseRahoitusalue
          selectedRahoitusalue={selectedRahoitusalue}
          availableRahoitusalueet={availableRahoitusalueet}
          allowEditing={allowEditing}
          helpTexts={helpTexts}
          onSelection={this.selectRahoitusalue}
        />
        <ChooseTalousarviotili
