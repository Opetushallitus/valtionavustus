...
> {
  ...
  constructor(props: PerustelutProps) {
    ...
    this.reasonBus.debounce(1000).onValue(([hakemus, newReason]) => {
      this.props.controller.setArvioPerustelut(hakemus, newReason);
    });
  ...
  static getDerivedStateFromProps(
    props: PerustelutProps,
    state: PerustelutState
  ) {
