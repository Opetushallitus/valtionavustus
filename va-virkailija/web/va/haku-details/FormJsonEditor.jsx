  ...
  render() {
    ...
    return formDraft ?
      <div id="form-json-editor"><h3>Hakulomakkeen sisältö</h3>
        <button type="button" disabled={disableSave} onClick={onClick}>Tallenna hakulomakkeen muutokset</button><span key="form-json-editor-error" className="error"> {parseError}</span>
