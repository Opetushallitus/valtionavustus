...
const Raportointivelvoite = ({
  ...
  const [raportointilaji, setRaportointilaji] = useState(
    raportointivelvoite?.raportointilaji
  );
  const [maaraaika, setMaaraaika] = useState(raportointivelvoite?.maaraaika);
  const [ashaTunnus, setAshaTunnus] = useState(
    raportointivelvoite?.["asha-tunnus"]
  );
    ...
    <div className="raportointivelvoitteet_row">
      ...
      <div className="raportointivelvoitteet_maaraaika">
        <h3 className="raportointivelvoitteet_label">
          ...
          <HelpTooltip
            content={
              helpTexts["hakujen_hallinta__haun_tiedot___raportin_määräaika"]
            }
            direction="left"
          />
        </h3>
      ...
      <div className="raportointivelvoitteet_buttons">
        ...
        <button
          ...
          onClick={() =>
            raportointivelvoite &&
            deleteRaportointivelvoite(index, raportointivelvoite)
          }
        >
          <RemoveButton />
        </button>
...
export const Raportointivelvoitteet = ({
  ...
  const putRaportointivelvoite = useCallback(
    debounce(async (index: number, r: Raportointivelvoite) => {
      ...
      setRaportointivelvoitteet(
        raportointivelvoitteet?.map((old, i) =>
