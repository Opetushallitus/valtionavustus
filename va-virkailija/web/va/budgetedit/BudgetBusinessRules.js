export default class BudgetBusinessRules {
  ...
  isSummingBudgetElementForProject(field) {
    return (
      field.fieldType === "vaSummingBudgetElement" &&
      field.id === this.projectBudgetFieldId
    );
  }

  isBudgetItemElementForProject(field) {
    return (
      field.fieldType === "vaBudgetItemElement" && field.params.incrementsTotal
    );
  }
  ...
  showDetailedCostsForBudgetField(field) {
    ...
    return !(
      this.isSummingBudgetElementForProject(field) ||
      this.isBudgetItemElementForProject(field)
    );
  }
}
