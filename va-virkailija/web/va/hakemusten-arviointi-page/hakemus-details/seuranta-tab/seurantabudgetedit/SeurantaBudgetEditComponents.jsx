...
export class EditSummingBudgetElement extends React.Component {
      ...
      field.params.showColumnTitles && (
        <thead>
          <tr>
            ...
            {visibleColumns.valiselvitysSum && (
              <th className="valiselvitys-amount-column money">Väli&shy;selvitys</th>
            )}
            {visibleColumns.loppuselvitysSum && (
              <th className="loppuselvitys-amount-column money">Loppu&shy;selvitys</th>
            )}
  ...
  static sumOf(field, answers) {
    return _.sum(
      VaBudgetCalculator.getAmountValuesAndSetRequiredFieldsByMutation(field, answers).map(
        (x) => x.value
      )
    )
  }
