...
export default class Login extends React.Component {
  render() {
    ...
    const errorMessage = (
      <div className="error">Sisäänkirjautuminen epäonnistui.</div>
    );
    const notPermittedMessage = (
      <div className="error">
        Sinulla ei ole oikeuksia valtionavustusjärjestelmään.
      </div>
    );
    const error = query.error === "true" ? errorMessage : undefined;
    const notPermitted =
      query["not-permitted"] === "true" ? notPermittedMessage : undefined;
    return (
      <div>
        ...
        <section id="container">
          ...
          <div hidden={!notPermitted} className="row">
            <a href={opintopolku.url + opintopolku["permission-request"]}>
              Ano lisää oikeuksia
            </a>{" "}
