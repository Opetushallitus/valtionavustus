...
(describe "Refuse URL"
          (it "generates proper refuse url"
              (should=
                "http://exampleurl.local/avustushaku/4/nayta?avustushaku=4hakemus=1234567890&lang=fi&preview=true&token=abcde1234567890&refuse-grant=true&modify-application=false"
