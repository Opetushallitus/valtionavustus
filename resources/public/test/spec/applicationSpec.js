(function () {
  ...
  function enterValidValues() {
    ...
    page.setInputValue("other-organizations-1-name-1", "Muu Testi Organisaatio")()
    page.setInputValue("other-organizations-1-email-1", "muutestiorganisaatio@example.com")()
