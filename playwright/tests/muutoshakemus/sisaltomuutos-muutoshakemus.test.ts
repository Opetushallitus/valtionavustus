...
const test = muutoshakemusTest.extend<{
  ...
  hakemustenArviointiPage: async (
    ...
    const sisaltomuutos =
      await hakijaMuutoshakemusPage.getMuutoshakemusSisaltomuutosPerustelut();
    ...
    const hakijaPerustelut =
      await hakemustenArviointiPage.getSisaltomuutosPerustelut();
...
test("can reject sisaltomuutos muutoshakemus", async ({
  ...
  const hakijaPerustelut =
    await hakemustenArviointiPage.getSisaltomuutosPerustelut();
  expect(hakijaPerustelut).toEqual(sisaltomuutosPerustelut);
  const virkailijaPerustelut =
    await hakemustenArviointiPage.getPaatosPerustelut();
...
test("can accept sisaltomuutos muutoshakemus", async ({
  hakemustenArviointiPage,
}) => {
...
test("can accept_with_changes sisaltomuutos muutoshakemus", async ({
  hakemustenArviointiPage,
}) => {
  await hakemustenArviointiPage.setMuutoshakemusSisaltoDecision(
