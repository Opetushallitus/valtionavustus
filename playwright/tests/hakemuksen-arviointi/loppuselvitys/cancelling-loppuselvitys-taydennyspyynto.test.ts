...
test('can cancel taydennyspyynto for loppuselvitys', async ({
  ...
  await test.step('can cancel täydennyspyyntö in asiatarkastus', async () => {
    await expect(loppuselvitysPage.locators.cancelTaydennyspyynto).not.toBeVisible()
    ...
    await expect(loppuselvitysPage.locators.cancelTaydennyspyynto).toBeVisible()
    ...
    await loppuselvitysPage.locators.cancelTaydennyspyynto.click()
