...
test.describe.parallel("Form util", function () {
  ...
  test.describe(
    "Finding first matching field, ignoring identifier index suffix",
    function () {
  ...
  test.describe(
    "finding index of child field according to field specification",
    function () {
  ...
  test("returns id without index", function () {
    expect(FormUtil.withOutIndex("foo.man-1.bar_zap-2")).toEqual(
      "foo.man.bar_zap"
    );
  });
