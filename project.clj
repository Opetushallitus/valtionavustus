...
(defproject oph-va/valtionavustus "0.1.0-SNAPSHOT"
  ...
  :managed-dependencies [
                         ...
                         ;; ... -> [com.google.guava/guava "33.4.8-android"] ->
                         [org.checkerframework/checker-qual "3.50.0"]
                         ...
                         ;; [ring/ring-core "1.14.2"] -> [commons-io "2.20.0"]
                         ;; [org.apache.tika/tika-core "3.2.2"] -> [commons-io "2.20.0"]
                         [commons-io "2.20.0"]
                         ...
                         ;; testing
                         [speclj "3.11.0" :exclusions [org.clojure/tools.reader org.clojure/java.classpath]]
                         [speclj-junit "0.0.11"]
  ...
  :dependencies [[org.clojure/clojure "1.12.2"]
                 ...
                 [org.apache.tika/tika-core "3.2.2"] ; attachment handling
