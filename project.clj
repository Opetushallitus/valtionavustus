...
(defproject oph-va/valtionavustus "0.1.0-SNAPSHOT"
  ...
  :managed-dependencies [
                         ...
                         ;; [org.apache.tika/tika-core "3.3.2"] -> [commons-io "2.22.0"]
                         [commons-io "2.22.0"]
  ...
  :dependencies [[org.clojure/clojure "1.12.5"]
                 ...
                 [org.apache.tika/tika-core "3.3.2"] ; attachment handling

                 ;; auth
                 [buddy/buddy-auth "3.0.323"]
                 [buddy/buddy-sign "3.6.1-359" :exclusions [org.bouncycastle/bcprov-jdk18on]]
                 [org.bouncycastle/bcprov-jdk18on "1.85.2"] ;; CVE-2024-29857, CVE-2024-30171, CVE-2024-30172
                 ...
                 ;; täsmäytysraportti
                 [clj-pdf "2.8.1" :exclusions [org.apache.xmlgraphics/xmlgraphics-commons]]
