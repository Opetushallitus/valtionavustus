    ...
    <>
      <div className="muutoshakemus__page-title">
        <h1 className="muutoshakemus__title">
          {t.contactPersonEdit.haku}:{" "}
          <span data-test-id="avustushaku-name">{avustushakuName}</span>
        </h1>
      </div>
      <div className="muutoshakemus__form">
        <div className="muutoshakemus__form-row">
          <div className="muutoshakemus__form-cell">
            ...
            <div
              className="muutoshakemus__hanke-name__name"
        ...
        <div className="muutoshakemus__form-row">
          <div className="muutoshakemus__form-cell">
            <label
              className="muutoshakemus__label"
              htmlFor="muutoshakemus__contact-person"
            >
