...
export const TalousarvioForm = ({
  f,
  talousarvio,
}: MuutosTaloudenKayttosuunnitelmaanProps) => {
  const { t, lang } = useTranslations();
  // @ts-ignore Formik provides incorrect error type
  const currentSumErrorClass = f.errors.talousarvio?.currentSum
    ? "currentSumError"
    : "";
  // @ts-ignore Formik provides incorrect error type
  ...
  return (
    <>
      <div
        className="muutoshakemus_talousarvio"
        data-test-id="talousarvio-form"
      >
      ...
      <div className="muutoshakemus_talousarvio_row">
        ...
        <div className="changedAmount" data-test-id="current-sum">
          <b className={currentSumErrorClass}>
            {f.values.talousarvio?.currentSum}
          </b>
        </div>
