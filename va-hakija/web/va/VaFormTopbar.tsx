...
const VaFormTopbar = <T extends BaseStateLoopState<T>, K>(
  ...
  const selvitysNotUpdateable =
    (isValiselvitys || isLoppuselvitys) && selvitysUpdateable === false;
  ...
  return (
    <section id="topbar">
      ...
      <span hidden={true} id="entity-version">
        {formOperations.responseParser.getSavedVersion(
          state.saveStatus.savedObject
        )}
      </span>
