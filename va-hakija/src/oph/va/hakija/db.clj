...
(defn refuse-application [application submission budget-totals comment]
  (update-status
    (:avustushaku application) (:user_key application)
    (:form_submission_id application) (:version application)
    (:register_number application) (:answers submission)
     budget-totals :refused comment))
