...
REQUIRED_NPM := $(shell if [ $(NPM_VERSION) == "7.24.0" ]; then echo true; else echo false; fi)
...
.PHONY: check-node
check-node:
	@echo Build requires Node v16.9.1 && $(REQUIRED_NODE)
	@echo Build requires NPM 7.24.0 && $(REQUIRED_NPM)
